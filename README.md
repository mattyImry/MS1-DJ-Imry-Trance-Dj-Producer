...
The web-site is design with a "Mobile-First" approch.
...
* As a Promoter, I want to check Imry's biography page, reviews from professionals, check social media and listening to Imry's music to consider future bookings. The promoter can come back to the web site to see the progression of my carrier via checking new reviews, listen to new music and check information via social icons.

### **_Colors Scheme_**

The project was develop by keeping colors to a minumum with a technical edge due to the way I see the technicality of the music production phase. I took the inspiration by the color scheme used in the video project "Resume Project" Code Institute "User Centric Front End Development Project". 

I have used the following color throughout the web-site.

Nav bar and footer have back ground color (#23374c) which mark nicely the start and end of the page. 

The Nav-bar has the color (#676767) for the page name when not active. When the page are view so they are active they become color (#fafafa) which contrast with the dark back ground color of the Nav-bar.

The Footer has the social media icons color (#fafafa) which contrast with the dark color of the Footer.

On the home page the background color for the testimonial part is color (#676767). 

This color has been used in the Biography page as a background color. Where at the top I have used a black "Imry logo" and the writing describing the Biography is color (#fafafa) which give a nice contrast for an easy reading specially in small devices.

The color (#676767) has also been used for the background color of the Listen page . Here as well to keep the color scheme consistant I have used the color (#fafafa) for the section titles and for the top of the page.

On the booking page the colors used are only for the botton (#676767) and the wording the color (#fafafa).
...
The web site has been developed to make the user able to navigate any page
with easy in any page that are viewing. 
...
The Navbar has the "Imry logo" on the top left that if clicked will take the user to the Home page in both mobile and desktop view. On mobile view the navbar collect under a burger menu icon for all four pages.
...
The listen page consist of three section. All the sections have few music players taken from [Soundcloud](https://soundcloud.com/). On each section the user can listen to : Dj sets, Live sets and single tracks.
...
1. [HTML](https://en.wikipedia.org/wiki/HTML) has been used in this project becasue is the standard markup language for documents designed to be displayed in a web browser.
...
4. [FONTAWESOME](https://fontawesome.com/) has been used to implement social icons.

5. [GOOGLEFONTS](https://fonts.google.com/) has been used to style the fonts of thw writing on the web site.
...
On CSS page a parse error on line 269 (still need to be addressed).
...
* The links present in the Navbar area all responding correctly in all pages.
* The links in the Footer are all responding correctly in all pages.

2. ### **_Responsive design_**

* The website has been developed with mobile first design. The users can view effectively the web site in mobile and tablet as in desktop. With the use of Bootstrap 4 features on mobile view the Navbar will change in a drop down menu. Pictures and texts in all pages will be shown in a vertically pleasent way in mobile view. The picture and text in the rest of the pages will adjust the sizes accondingly to the different devices without destorting the images.

3. ### **_Users Scenarios_**

* All the three type of User, mentioned in the "User Stories section", can click in any link in the Navbar to access all the other pages. In any pages the user is viewing can click the "Imry Logo" in the Navbar and will be ridirected in the home page. In any pages the User is visiting can click in the social icons in the Footter and a new page will open with the social media web site without loosing the page is viewing. All links in the listening page are playing the music from [SoundCloud](https://soundcloud.com/) as intended.
 ...
 * If the User does not enter a valid e-mail address in the e-mail address section of the form an error "Please include an "@" in the email address" will show.
